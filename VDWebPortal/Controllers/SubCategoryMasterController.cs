...
namespace VDWebPortal.Controllers
{
    public class SubCategoryMasterController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "SubCategoryID,CategoryID,SubCategoryName,SubCategoryDesc,Sequence,CreatedBy,CreatedDate,ModifiedBy,ModifiedDate,Active")] M_SubCategoryMaster m_SubCategoryMaster)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "SubCategoryID,CategoryID,SubCategoryName,SubCategoryDesc,Sequence,CreatedBy,CreatedDate,ModifiedBy,ModifiedDate,Active")] M_SubCategoryMaster m_SubCategoryMaster)
        {
            if (ModelState.IsValid)
            {
